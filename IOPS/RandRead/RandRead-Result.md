...
# Summary 
From what i've been observed KIOPS will increase significantly when numjobs and threads on the right number, but if both of variable get higher number it will get consistent performance of KIOPS but sometimes it will drop significantly to. Meanwhile i've been create data that compare KIOPS performance in every result 
